...
- The system can identify objects in images correctly.
- It can answer user questions related to the image.
- The chatbot makes interaction simple and user-friendly.

## 6. Limitations

- Accuracy depends on the quality of the dataset
- Cannot understand very complex questions
- Needs good system performance
---

## 7. Future Scope

- Add voice interaction
- Use live camera instead of uploaded images
...
This project successfully creates a chatbot that can understand images and talk with users. It makes AI more interactive and useful in real-life applications.
